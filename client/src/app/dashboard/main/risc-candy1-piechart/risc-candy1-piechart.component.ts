...
@Component({
  selector: 'app-risc-candy1-piechart',
  templateUrl: './risc-candy1-piechart.component.html',
  styleUrls: ['./risc-candy1-piechart.component.css']
})

export class RiscCandy1PiechartComponent implements OnInit {
  // Pie
