...
@Component({
  selector: 'app-risc-candy2-piechart',
  templateUrl: './risc-candy2-piechart.component.html',
  styleUrls: ['./risc-candy2-piechart.component.css']
})

export class RiscCandy2PiechartComponent implements OnInit {
  // Pie
